...
public class TransaksiAdapter extends RecyclerView.Adapter<TransaksiAdapter.TransaksiHolder> {
    ...
    List<ModelTransaksi> mList;

    public TransaksiAdapter(DataTransaksi dataTransaksi, List<ModelTransaksi> mList) {
    ...
    public TransaksiHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(dataTransaksi).inflate(R.layout.data_transaksi, parent, false);
        return new TransaksiHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull TransaksiHolder holder, int position) {
        final ModelTransaksi transaksi = mList.get(position);
        ...
        holder.card_transaksi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(dataTransaksi, DetailTransaksi.class);
                ...
                dataTransaksi.startActivity(intent);
            }
        });
    ...
    public class TransaksiHolder extends RecyclerView.ViewHolder {
        ...
        private CardView bg_status, card_transaksi;
