...
public class DetailRiwayatAdapter extends RecyclerView.Adapter<DetailRiwayatAdapter.DetailRiwayatHolder> {

    DetailRiwayatTransaksi detailRiwayatTransaksi;
    List<ModelDetailTransaksi> list;
    List<ModelBuku> listBuku;

    public DetailRiwayatAdapter(DetailRiwayatTransaksi detailRiwayatTransaksi, List<ModelDetailTransaksi> list, List<ModelBuku> listBuku) {
        this.detailRiwayatTransaksi = detailRiwayatTransaksi;
        this.list = list;
    ...
    @NonNull
    @Override
    public DetailRiwayatHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(detailRiwayatTransaksi).inflate(R.layout.data_detail_riwayat, parent, false);
        return new DetailRiwayatHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull DetailRiwayatHolder holder, int position) {
        ...
        Glide.with(detailRiwayatTransaksi).load(buku.getImage()).into(holder.image_buku);
    }
    ...
    public class DetailRiwayatHolder extends RecyclerView.ViewHolder {
        ...
        public DetailRiwayatHolder(@NonNull View itemView) {
            super(itemView);
